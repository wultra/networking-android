...
/** Dummy PowerAuth SDK configuration valid for SDK 2.0+. Used by both mock and real-server tests. */
...
// ============================================================================
// Test configuration (loaded from androidTest assets/config.json)
// ============================================================================
...
/** Creates a [PowerAuthSDK] instance with [DUMMY_SDK_CONFIG], useful for offline / mock tests. */
...
// ============================================================================
// Integration proxy (PowerAuth Cloud lifecycle for real-server tests)
// ============================================================================

/**
 * Manages PowerAuth activation lifecycle against a real PowerAuth Cloud server.
 *
 * Usage:
 * ```
 * val proxy = IntegrationProxy(config, context)
 * proxy.initializePowerAuth()
 * proxy.prepareActivation()   // optional — only if the test needs a signed/token flow
